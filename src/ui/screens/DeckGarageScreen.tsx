...
export function DeckGarageScreen({
  ...
  return (
    <div className="deck-garage-screen" data-testid="deck-garage-screen">
      <header className="deck-garage-header">
        <div className="deck-garage-heading">
          ...
          <p className="deckbuilder-subtitle">
            Pick a committed deck to run the street, or crack open a fresh box and build a new crew from scratch.
          </p>
        </div>
      ...
      <section className="deck-garage-rail" aria-label="Saved decks">
        {loadouts.map((deck) => (
          <article key={deck.id} className="deck-box-card">
            <CardFrame variant="crew" className="card-frame-svg card-frame-svg-deck-box" />
            ...
            <div className="deck-box-actions">
              <button className="menu-button menu-button-primary deck-box-action" onClick={() => onPlayDeck(deck.id)}>
                <CardFrame variant="button" className="card-frame-svg card-frame-svg-button" />
                <span className="menu-button-label">Play</span>
              </button>
              <button className="deck-mini-button deck-box-edit" onClick={() => onEditDeck(deck.id)}>
                <CardFrame variant="button" className="card-frame-svg card-frame-svg-utility-button" />
        ...
        <article className="deck-box-card deck-box-card-new">
          ...
          <div className="deck-box-summary">Open a new box, pull the cards, and start building.</div>
          <div className="deck-box-actions">
            <button className="menu-button menu-button-primary deck-box-action" onClick={onCreateDeck} data-testid="new-deck-button">
              <CardFrame variant="button" className="card-frame-svg card-frame-svg-button" />
