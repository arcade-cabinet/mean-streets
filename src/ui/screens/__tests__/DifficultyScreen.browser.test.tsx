...
describe('DifficultyScreen (browser)', () => {
  ...
  it('renders the difficulty grid in the browser', async () => {
    ...
    expect(
      document.querySelector('[data-testid="difficulty-screen"]'),
    ).not.toBeNull();
  ...
  it('selects a tier on click', async () => {
    ...
    const hardTile = document.querySelector<HTMLElement>(
      '[data-testid="diff-tile-hard"]',
    )!;
    hardTile.click();
    await settleBrowser();
  ...
  it('calls onSelect with config when Start is clicked', async () => {
    ...
    const startBtn = document.querySelector<HTMLElement>(
  ...
  it('toggles permadeath in the browser', async () => {
    ...
    document
      .querySelector<HTMLElement>('[data-testid="diff-permadeath"]')!
      .click();
    await settleBrowser();
